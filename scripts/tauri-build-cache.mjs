      ...
      webSources: inputs.webSources?.filter(
        ([name]) =>
          ![
            ...
            "scripts/browser-compat-interactive.mjs",
            "scripts/browser-compat-monitor.mjs",
            "scripts/browser-compat-options.mjs",
            "scripts/browser-compat-run.mjs",
            "scripts/browser-compat-smoke.mjs",
            "scripts/browser-compat-support.mjs",
            "scripts/browser-compat-ui.mjs",
            "scripts/cache-handoff-test.mjs",
            "scripts/prepare-snake-audio-fixture.mjs",
            "scripts/web-test-lib.mjs",
            "scripts/web-test-browser.mjs",
            "scripts/web-test-lib.d.mts",
            "scripts/web-test-project.mjs",
            "scripts/web-test-query.mjs",
