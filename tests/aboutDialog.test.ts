...
describe("AboutDialog", () => {
  ...
  it("shows the Tauri release suffix in the desktop host", () => {
    ...
    expect(document.body.textContent).toContain("0.5.0-tauri");
