...
describe("AboutDialog", () => {
  ...
  it("shows authorship, frontend/core versions, and license", async () => {
    ...
    expect(document.body.querySelectorAll(".about-details dd")[1]?.textContent).toBe("0.10.0-alpha.1-wasm");
  ...
  it("shows the Tauri release suffix in the desktop host", () => {
    ...
    expect(document.body.querySelectorAll(".about-details dd")[1]?.textContent).toBe("0.10.0-alpha.1-tauri");
